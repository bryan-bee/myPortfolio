    ...
    <div className='interests_main' id='interests'>
      ...
      <div className='interests'>
        ...
        <div className='interests_1 fs1'>
            Hi, nice to meet you! I'm a recent graduate from <b className="calstate-la">CalState Los Angeles</b> where I earned my
            B.S. in Computer Science and graduated with honors, summa cum laude. I'm a very curious person by nature and am always looking for
